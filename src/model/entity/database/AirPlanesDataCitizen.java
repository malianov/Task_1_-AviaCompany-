...
public enum AirPlanesDataCitizen {
    ...
    AirPlanesDataCitizen(String vendor, String model, int passengersCapacity, int cargoCapacity, int maxFlyDistance, int fuelTankVolume) {
        this.vendor             = vendor;
        this.model              = model;
